...
<!-- Bootstrap 5 JS Bundle CDN (bao gồm Popper.js — cần cho Dropdown, Modal, Tooltip) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-YvpcrYf0tY3lHB60NNkmXc4s9bIOgUxi8T/jzmArFmcZZm7MFEBp3VLFHnFX8oH"
        crossorigin="anonymous"></script>

<!-- JS tùy chỉnh của dự án — đặt cuối body để không block render -->
<script src="/bookstore/assets/js/main.js"></script>
